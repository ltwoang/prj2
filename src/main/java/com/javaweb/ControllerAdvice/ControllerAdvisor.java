...
import com.javaweb.customerException.FieldRequireException;
...
public class ControllerAdvisor extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<Object> handleFeildRequireException(FieldRequireException ex, WebRequest request) {
    ErrorResponeDTO errorResponeDTO = new ErrorResponeDTO();
    errorResponeDTO.setError(ex.getMessage());
    List<String> details = new ArrayList<String>();
